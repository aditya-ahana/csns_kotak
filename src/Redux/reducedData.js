...
export const currentDate = dayjs(new Date()).format("DD-MM-YYYY");

export const requestPhases = ["Completed", "In-progress", "Failed"].sort();

export const availableReportTypes = ["PDF", "Excel"].sort();
...
export const viewDetailHeaders = [
  "Ticket Id",
  "Reports",
  "Status",
  "Created Date",
