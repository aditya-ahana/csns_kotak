...
import { readOnly, requestList, requestPhases } from "../../components/data/requestsData";
...
export default function ViewRequest() {
      ...
      textField: {
        ...
        sx: {
          ...
          "& .MuiOutlinedInput-root": {
            "& fieldset": {
              border: fromDate === "" ? "1.45px solid rgb(255, 0, 0)" : "1.85px solid rgb(0, 142, 0)",
            },
            "&:hover fieldset": {
    ...
    toSlotProps: {
      ...
      textField: {
        ...
        sx: {
          ...
          "& .MuiOutlinedInput-root": {
            "& fieldset": {
              border: toDate === "" ? "1.45px solid rgb(255, 0, 0)" : "1.85px solid rgb(0, 142, 0)",
            },
            "&:hover fieldset": {
              border: "1.5px solid rgb(67, 61, 139)",
            },
  ...
  const date_ranged = fromDate !== "" || toDate !== "" || (fromDate !== "" && toDate !== "");
            ...
            {loading === true ? (
              ...
              <>
                    <Box className="view-request-header">
                      <Box className="request-searchbar" sx={{ opacity : retrieving === true ? 0.25 : 1 }}>
                      ...
                      <Button
                        ...
                        aria-controls={
                          viewFilterMenu ? "filter-menu" : undefined
                        }
                        aria-haspopup="true"
                                ...
                                >
                                  <DatePicker
                                    ...
                                    shouldDisableDate={(day) =>
                                      dayjs(day).isAfter(dayjs(toDate, "DD-MM-YYYY"), "day")
                                    }
